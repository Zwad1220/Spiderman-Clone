...
public struct SwingAnchorCandidate
{
    public Transform Anchor;
    public float Distance;
}

public interface ISwingTargetProvider
{
    IReadOnlyList<SwingAnchorCandidate> VisibleAnchors { get; } // sorted closest-first
    Transform CurrentAnchor { get; } // VisibleAnchors[0], or null
}